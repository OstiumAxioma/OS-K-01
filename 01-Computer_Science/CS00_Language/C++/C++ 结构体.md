...
> [!tip]
> 可以把结构体视作一种简化版的[[Class and Object 面向对象基本元素-类与对象|Class 类]]：
> 
...
> - “class”这个关键字还用于定义模板参数，就像“typename”。但关建字“struct”<font color="#c0504d">不用于</font>定义模板参数

> [!important]
> 结构体主要是面向过程编程中使用的概念，在C中被首先发明，C++保留这个特性更多的是为了向下兼容
...
> [!warning]
> 为了使用<font color="#c0504d">指向该结构的指针</font>访问结构的成员，您必须使用 `->` 运算符，如下所示：
